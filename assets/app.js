...
function renderServices() {
  ...
  const serviceCards = services.map(s => {
    ...
    const bgMap = { srv_remote_install:'#2563eb', srv_support:'#059669', srv_update:'#7c3aed', srv_config:'#d97706', srv_radio_unlock:'#dc2626', srv_gps_maps_update:'#0891b2' };
    const svgMap = {
      ...
      srv_gps_maps_update: `<svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" width="26" height="26"><path d="M12 21s7-7.58 7-12A7 7 0 105 9c0 4.42 7 12 7 12z"/><circle cx="12" cy="9" r="2.3"/></svg>`
    };
