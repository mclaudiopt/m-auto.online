# install/psa_download_v2.ps1 v2.0 - PSA Pack Download (Enhanced)
...
function Write-Header {
    ...
    Write-Host "  ${e}[38;2;29;155;255mâ•‘${e}[0m  ${e}[1;97mPSA Pack 2026${e}[0m  ${e}[38;2;100;149;237mâ”‚  Enhanced Downloader${e}[0m      ${e}[38;2;29;155;255mâ•‘${e}[0m"
...
function Get-ProgressBar($percent, $width = 50) {
    ...
    $barFill = "${e}[48;2;${color}m" + ("â–ˆ" * $filled) + "${e}[0m"
    $barEmpty = "${e}[48;2;30;41;59m" + ("â–‘" * $empty) + "${e}[0m"
...
while ($retry -lt $maxRetries) {
    ...
    if ($links) {
        ...
        Write-Host ""
        Write-Host "  ${e}[38;2;100;149;237mâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•${e}[0m"
