...
function Write-Header {
    ...
    Write-Host ""
    Write-Host "  ${e}[38;2;255;195;0m${e}[1mMercedes Full Pack${e}[0m  ${e}[38;2;180;140;0mDownload${e}[0m"
...
while ($retry -lt $maxRetries) {
    ...
    if ($links) {
        ...
        if ($choice -eq "L" -or $choice -eq "l") { Show-Links; continue }
        ...
        Write-Header
        Write-OK "A transferir $($toDownload.Count) ficheiro(s) $([char]0x2014) 16 conexoes por ficheiro..."
        Write-Host ""
